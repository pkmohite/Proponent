...
def create_sales_deck():
    ...
    with open("pkmohite/proponent/main/downloads/combined_PDF.pdf", "rb") as file:
        col3.download_button(
    ...
    if os.path.exists("pkmohite/proponent/main/downloads/combined_PDF.pdf"):
        displayPDF("pkmohite/proponent/main/downloads/combined_PDF.pdf", width=820, height=640)
    else:
